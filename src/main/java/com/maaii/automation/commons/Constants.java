...
public class Constants {
    ...
    /**
     * The Shell Script execution log file.
     */
    public static final String SHELL_EXECUTION_LOG = "ShellExecutionLog.txt";
    /**
     * Thd directory for Shell Script execution log.
     */
    public static final String SHELL_EXECUTION_LOG_DIR = "target" + File.separator + "surefire-reports" + File.separator + SHELL_EXECUTION_LOG;
    /**
    ...
    public static final String JENKINS_WS_DIRECTORY = "http://localhost:8080/job/" + System.getProperty("jobName") + "/ws";
